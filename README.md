...
![alt text](https://github.com/natyrrr/serenity4solidity/blob/main/screenshots/deploying%20%231.png)

### TRANSACTION
![alt text](https://github.com/natyrrr/serenity4solidity/blob/main/screenshots/transaction%20contract%201.png)

### ENDING BALANCES
![alt text](https://github.com/natyrrr/serenity4solidity/blob/main/screenshots/contract%201%20ending%20account%20balances.png)
...
## Testing out Contract 2

### DEPLOYING THE CONTRACT
![alt text](https://github.com/natyrrr/serenity4solidity/blob/main/screenshots/deploying%202nd%20contract.png)

### TRANSACTION
![alt text](https://github.com/natyrrr/serenity4solidity/blob/main/screenshots/sending%20ether%202nd%20contract.png)

### ENDING BALANCE

![alt text](https://github.com/natyrrr/serenity4solidity/blob/main/screenshots/balances%202nd%20contract.png)
...
3. Create a uint called total_shares and set this to 1000.
...
5. The uint start_time = now; line permanently stores the contract's start date. We'll use this to calculate the vested shares later. Below this variable, set the unlock_time to equal now plus 365 days. We will increment each distribution period.


6. The uint public distributed_shares will track how many vested shares the employee has claimed and was distributed. By default, this is 0.
...
![alt text](https://github.com/natyrrr/serenity4solidity/blob/main/screenshots/contract%203%20deployment.png)

### TRANSACTION
![alt text](https://github.com/natyrrr/serenity4solidity/blob/main/screenshots/contract%203%20deposit%20log.png)
